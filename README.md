...
- [Color Palette](https://github.com/s0tfs/godot-color-palette)
- Simple Project Timer <- adaptar

# Godot 3, Addons adaptados
- Color Preview <- adaptar
- [Simple Project Timer](https://github.com/RipeX/simple-project-timer)
...
- [kanban tasks](https://github.com/HolonProduction/godot_kanban_tasks)
...
- [Godot Universal Fade](https://github.com/KoBeWi/Godot-Universal-Fade)
- [kanban tasks](https://github.com/HolonProduction/godot_kanban_tasks)
- [MaxSizeContainer](https://github.com/MattUV/godot-MaxSizeContainer)
- [EditorFlyCam](https://github.com/Schroedi/EditorFlyCam)

# Godot 3 no testing
- [Shader Cache](https://github.com/imjp94/gd-shader-cache)

# Demos Oficiales
- [input mapping](https://github.com/godotengine/godot-demo-projects/tree/3.5-9e68af3/gui/input_mapping)
- [mic record](https://github.com/godotengine/godot-demo-projects/tree/3.5-9e68af3/audio/mic_record)
- [audio generator](https://github.com/godotengine/godot-demo-projects/blob/3.5-9e68af3/audio/generator/generator_demo.gd)
